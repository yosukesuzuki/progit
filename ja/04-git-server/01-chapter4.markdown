...
![図 4-1. GitWeb のユーザーインターフェイス](../../figures/18333fig0401-tn.png)
...
![図 4-2. GitHub のプラン説明ページ](../../figures/18333fig0402-tn.png)

ユーザー名を選び、メールアドレスを入力します。アカウントとパスワードがこのメールアドレスに関連づけられます (図 4-3 を参照ください)。

![図 4-3. GitHub のユーザー登録フォーム](../../figures/18333fig0403-tn.png)
...
![図 4-4. GitHub のユーザーダッシュボード](../../figures/18333fig0404-tn.png)
...
![図 4-8. 公開 URL とプライベート URL が表示されたヘッダ](../../figures/18333fig0408-tn.png)
...
![図 4-9. Subversion からのインポート](../../figures/18333fig0409-tn.png)
...
![図 4-10. GitHub の管理者用ページ](../../figures/18333fig0410-tn.png)
...
![図 4-11. プロジェクトへの共同作業者の追加](../../figures/18333fig0411-tn.png)

対象者を全員追加し終えたら、Repository Collaborators のところにその一覧が見えるはずです (図 4-12 を参照ください)。

![図 4-12. プロジェクトの共同作業者一覧](../../figures/18333fig0412-tn.png)
...
![図 4-13. GitHub プロジェクトのメインページ](../../figures/18333fig0413-tn.png)
...
![図 4-14. 任意のプロジェクトの書き込み可能なコピーを取得する "fork" ボタン](../../figures/18333fig0414-tn.png)

数秒後に新しいプロジェクトのページに移動します。そこには、このプロジェクトがどのプロジェクトのフォークであるかが表示されています (図 4-15 を参照ください)。

![図 4-15. フォークしたプロジェクト](../../figures/18333fig0415-tn.png)
